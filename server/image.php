...
function writeInvitation($dpi, $nombre)
{
    ...
    $white = imagecolorexact($imgBase, 255, 255, 255);
    ...
    imagettftext($imgBase, $font_size, 0, 20, 320, $white, $FONT_PATH, $nombre);

    $bbox2 = imagettfbbox($font_size, 0, $FONT_PATH, $dpi);

    $dest_x2 = $bbox2[0] + (imagesx($imgBase) / 2) - ($bbox2[4] / 2) - 25;

    imagettftext($imgBase, $font_size, 0, 20, 365, $white, $FONT_PATH, 'DPI: ' . $dpi);
